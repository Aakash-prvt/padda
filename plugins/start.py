...
from bot import Bot
from config import ADMINS, FORCE_MSG, START_MSG, CUSTOM_CAPTION, DISABLE_CHANNEL_BUTTON, PROTECT_CONTENT, FILE_AUTO_DELETE, REQUEST
...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
    [
        InlineKeyboardButton("ɴᴇᴛᴡᴏʀᴋ", url="https://t.me/Pleasure_Adda2"),
        InlineKeyboardButton("ᴀʙᴏᴜᴛ", callback_data = "about"),
    ],
    [
        InlineKeyboardButton("ᴄʜᴀɴɴᴇʟs", url="https://t.me/addlist/4EIL3fa7krIyOGQ1")
    ]
            ]
        )
